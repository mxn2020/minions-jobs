# Manual Setup Steps for Minions Jobs
...
Go to **GitHub → mxn2020/minions-jobs → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-jobs` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-jobs-web`
- **GitHub repo**: `mxn2020/minions-jobs`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `jobs.minions.wtf`

### Documentation
- **Netlify site name**: `minions-jobs-docs`
- **GitHub repo**: `mxn2020/minions-jobs`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `jobs.minions.help`

### Blog
- **Netlify site name**: `minions-jobs-blog`
- **GitHub repo**: `mxn2020/minions-jobs`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `jobs.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `jobs.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `jobs.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `jobs.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-jobs/sdk`](https://www.npmjs.com/package/@minions-jobs/sdk)
- CLI: [`@minions-jobs/cli`](https://www.npmjs.com/package/@minions-jobs/cli)
...
Your package: [`minions-jobs`](https://pypi.org/project/minions-jobs/)
...
| Item | Value |
|------|-------|
| Project | `minions-jobs` |
| SDK (npm) | `@minions-jobs/sdk` |
| CLI (npm) | `@minions-jobs/cli` |
| Python (PyPI) | `minions-jobs` |
| GitHub | `github.com/mxn2020/minions-jobs` |
| Docs domain | `jobs.minions.help` |
| Blog domain | `jobs.minions.blog` |
| App domain | `jobs.minions.wtf` |
